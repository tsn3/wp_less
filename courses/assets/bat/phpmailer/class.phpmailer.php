...
class PHPMailer
{
     ...
     * This can include /assets/images, sounds, and just about any other document type.
     * Be sure to set the $type to an image type for /assets/images:
     * JPEG /assets/images use 'image/jpeg', GIF uses 'image/gif', PNG uses 'image/png'.
     ...
     * Automatically makes modifications for inline /assets/images and backgrounds
        ...
        if (isset($/assets/images[2])) {
            foreach ($/assets/images[2] as $imgindex => $url) {
                ...
                if (preg_match('#^data:(image[^;,]*)(;base64)?,#', $url, $match)) {
                    ...
                    // Do not change urls for absolute /assets/images (thanks to corvuscorax)
